<?php echo breadcrumb(array(
    'links' => array(
        ...
        array('name' => lang('Создание игрового аккаунта'), 'current' => true),
    ),
)) ?>
        ...
        <fieldset>
            <?php if(count($server_list) > 1) { ?>
                <div class="control-group<?php echo (form_error('server_id') ? ' error' : '') ?>">
                    ...
                    <div class="controls">
                        <?php echo form_dropdown('server_id', $server_list, (validation_errors() ? set_value('server_id') : ''), 'style="width: 280px;"') ?>
            ...
            <button class="btn btn-primary" style="margin: 0 0 0 165px;" type="submit" name="submit"><?php echo lang('Создать') ?></button>
        </fieldset>
    <?php echo form_close() ?>
<?php }