<?php echo breadcrumb(array(
    'links' => array(
        ...
        array('name' => lang('Смена пароля от аккаунта') . ' ' . get_segment_uri(4), 'current' => true),
    ),
)) ?>
...
<?php echo form_open('', 'class="form-horizontal"') ?>
    <fieldset>
        ...
        <button class="btn btn-primary" style="margin: 0 0 0 165px;" type="submit" name="submit" data-text="<?php echo lang('Загрузка...') ?>"><?php echo lang('Изменить') ?></button>
    </fieldset>
<?php echo form_close() ?>