<table class="table table-striped table-bordered">
    <thead>
        <tr>
            <th width="35%"><?php echo lang('Название клана') ?></th>
            <th width="10%"><?php echo lang('Уровень') ?></th>
            <th width="15%"><?php echo lang('Замок') ?></th>
        ...
        <?php if($content) { ?>
            <?php foreach($content as $row) { ?>
                <tr>
                    ...
                    ?><p class="desc" style="font-size: 11px;"><?php echo lang('Лидер') ?>: <?php echo $row['char_name'] ?></p></td>
