<div class="page-header">
    <h1>Магазин <small>редактирование товара</small></h1>
</div>
...
<?php echo form_open('', 'class="form-horizontal"') ?>
    <fieldset>
        <div class="control-group<?php echo (form_error('item_id') ? ' error' : '') ?>">
            ...
            <div class="controls">
                <input type="hidden" name="item_id" value="<?php echo set_value('item_id', $content['item_id']) ?>" />
                <input type="text" name="item_name" id="item_name" value="<?php echo (isset($_POST['item_name']) ? $_POST['item_name'] : $content['name']) ?>" class="span10" placeholder="Введите название предмета" />
        ...
        <div class="control-group<?php echo (form_error('price') ? ' error' : '') ?>">
            ...
            <div class="controls">
                <input type="text" name="price" id="price" value="<?php echo set_value('price', $content['price']) ?>" class="span10" placeholder="Введите Цену" />
        ...
        <div class="control-group<?php echo (form_error('count') ? ' error' : '') ?>">
            ...
            <div class="controls">
                <input type="text" name="count" id="count" value="<?php echo set_value('count', $content['count']) ?>" class="span10" placeholder="Введите Кол-во единиц которые входят в цену выше" />
        ...
        <div class="control-group<?php echo (form_error('date_start') ? ' error' : '') ?>">
            ...
            <div class="controls">
                <input type="text" name="date_start" id="date_start" value="<?php echo set_value('date_start', ($content['date_start']  == '0000-00-00 00:00:00' ? '' : $content['date_start'])) ?>" class="span10" placeholder="Введите Дату начала продаж" />
        ...
        <div class="control-group<?php echo (form_error('date_stop') ? ' error' : '') ?>">
            ...
            <div class="controls">
                <input type="text" name="date_stop" id="date_stop" value="<?php echo set_value('date_stop', ($content['date_stop']  == '0000-00-00 00:00:00' ? '' : $content['date_stop'])) ?>" class="span10" placeholder="Введите Дату окончания продаж" />
                <p class="help-block">Формат ввода: Y-m-d H:i:s, к примеру 2012-03-10 22:47:10</p>
        ...
        <div class="control-group<?php echo (form_error('description') ? ' error' : '') ?>">
            ...
            <div class="controls">
                <textarea name="description" id="description" cols="30" rows="3" class="span10" placeholder="Введите Описание товара"><?php echo set_value('description', $content['description']) ?></textarea>
