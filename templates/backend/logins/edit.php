...
<?php echo form_open('', 'class="form-horizontal"') ?>
    <fieldset>
        ...
        <div class="control-group<?php echo (form_error('version') ? ' error' : '') ?>">
            ...
            <div class="controls">
                <?php echo form_dropdown('version', array_combine($this->config->item('types_of_servers', 'lineage'), $this->config->item('types_of_servers', 'lineage')), set_value('version', $content['version'])) ?>
