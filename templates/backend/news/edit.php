...
<?php echo form_open('', 'class="form-horizontal"') ?>
    <fieldset>
        ...
        <div class="control-group<?php echo (form_error('description') ? ' error' : '') ?>">
            ...
            <div class="controls">
                <textarea name="description" id="description" style="width: 778px;" cols="30" rows="7" placeholder="Описание новости"><?php echo set_value('description', $content['description']) ?></textarea>
